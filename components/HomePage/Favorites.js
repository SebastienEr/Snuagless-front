...
import { faStar, faMessage, faOtter, faFloppyDisk, faTrash, faImagePortrait } from "@fortawesome/free-solid-svg-icons";
...
function FavoriteModal({ currentSong, fetchCurrentSong }) {
    console.log("Current song received:", currentSong);
    console.log("a", currentSong);
