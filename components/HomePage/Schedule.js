...
function Schedule() {
  ...
  const [eventsAtNoon, setEventsAtNoon] = useState([]);
  const [eventsAtNight, setEventsAtNight] = useState([]);
                ...
                {[eventsAtNight].map((data) => {
                  return (
                    <>
                      ...
                      />
                      <div styles={styles.Litext}>
                        <text>22H- {data.title} </text> {/*Lundi 9h*/}
                      </div>
                    </>
                  );
                })}
              ...
              <li className={styles.Li}>
                {[eventsAtNight].map((data) => {
                  return (
                    <>
                      <Image
                        src="/artists/_fe2e8932-10c4-4f99-9eab-e56a86016448.jpg" /* Ajoutez le chemin correct */
                        className={styles.bigPicture1}
                        width={"190vh"}
                        height={"190vh"}
                      />
